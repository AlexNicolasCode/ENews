...
export default function Installation() {
    return (
        <>
            ...
            <GitHub />
            <artitle>
                <div className="doc pt-5 pl-3 mr-2 pt-md-5 pl-md-0 ml-md-9 pr-md-5" data-aos="fade-left" data-aos-duration="700">
                    <h1 className="docs bg-dark p-1 text-white">Docs</h1>
                    <Commands />
                    <Fonts />
                    <Releases />
                </div>
