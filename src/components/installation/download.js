            ...
            <section id="download">
                <Container>
                    ...
                    <Row className="doc">
                        ...
                        <Col xs="3">
                        <a href="https://github.com/AlexNicolasCode/ENews-DiscordBot"><Button outline className="doc__btn btn-outline-dark rounded-0">Discord</Button></a><br/>
                        <a href="https://github.com/AlexNicolasCode/ENews-TelegramBot"><Button outline className="doc__btn btn-outline-dark rounded-0">Telegram</Button></a>
                        </Col>
                        <p>
