        ...
        <section id="discord">
            <Container>
                ...
                <Row className="doc">
                    ...
                    <img  alt="add a new bot" className="doc__img" src={bot}/>
                    <p>
                        Now, you will copy the token. Please, save this token, it very important.
                    </p>
                    <img  alt="copy token" className="doc__img" src={token}/>
                    <p>
                        Go to OAuth2 and select <strong>"bot"</strong> in scopes:
                    </p>
                    <img  alt="select your aplication like a bot" className="doc__img" src={checked}/>
                    <p>
                        Please, select options like this screenshot in <strong>"Bot Permissions"</strong>:
                    </p>
                    <img  alt="add bot permissions" className="doc__img" src={permissions}/>
                    <p>
                        In Scopes, you can see a link. Please, copy it and open and a new tab.
                    </p>
                    <img  alt="join our bot into a server" className="doc__img" src={join}/>
                    <p>
                        Join your bot into a Discord server and click <strong>"Authorize"</strong>:
                    </p>
                    <img  alt="authorize your bot to join" className="doc__img" src={join2}/>
                    <p>
